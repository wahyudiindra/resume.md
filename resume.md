...
- **Technologies:** Node.js, NestJS, NextJS, Prisma, Laravel, React, Vue.js
...
- Led the migration from Strapi (Headless CMS) to NestJS, enhancing system scalability and reducing maintenance overhead by 25%.
...
### <span>Employee Management System</span> _(Desember 2025 – now)_

Employee management system to visualize employee data by synchronizing information from a central database.  
_Tech Stack:_ NextJS, NestJS, Prisma, PostgreSQL, Mantine UI, Tailwind
